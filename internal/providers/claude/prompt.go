...
- price_min/price_max ให้เป็นราคาโดยประมาณเป็นจำนวนเต็ม หน่วยบาท (ห้ามมีทศนิยม, ห้ามมีคอมมา, ห้ามใส่หน่วย)
- ถ้างานฟรี (เช่น "เข้าฟรี", "ไม่มีค่าใช้จ่าย", "free entry") ให้ price_min=0 และ price_max=0
- ถ้าโพสต์ระบุราคาเดียว (เช่น "บัตร 500 บาท") ให้ price_min=price_max=500
- ถ้าโพสต์ระบุเป็นช่วง/หลายระดับ (เช่น "500-1500 บาท", "บัตร 800/1200/2000") ให้ price_min=ราคาต่ำสุด price_max=ราคาสูงสุด
- ถ้าเป็นราคาเริ่มต้น (เช่น "เริ่มต้น 300 บาท") ให้ price_min=300 และ price_max=null
- ถ้าโพสต์ไม่ได้บอกราคาเลย หรือบอกแค่ "สอบถามราคาทางแชท" ให้ price_min=null และ price_max=null — ห้ามเดาราคาเอง
- ถ้าราคาเป็นสกุลอื่นให้แปลงเป็นบาทโดยประมาณ และถ้าไม่มั่นใจให้เป็น null
- price_text ยังคงเก็บข้อความราคาตามที่โพสต์เขียนไว้เหมือนเดิม
